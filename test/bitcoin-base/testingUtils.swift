...
extension BitcoinScript {
    func run(_ stack: inout [Data], sigVersion: SigVersion = .base) throws {
        var context = ScriptContext(.standard, tx: .empty, inputIndex: -1, prevouts: [])
    ...
    func runV1(_ stack: inout [Data]) throws {
        ...
        var context = ScriptContext(config, tx: .init(version: .v1, locktime: .init(0), inputs: [.init(outpoint: .coinbase, witness: .init([]))], outputs: []), inputIndex: 0, prevouts: [])
