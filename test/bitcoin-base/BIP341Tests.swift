...
struct BIP341Tests {
    ...
    func scriptPubKey(
        ...
        let tweakedPubkeyData = PublicKey(internalKey + SecretKey(tweak)!).xOnly.data
    ...
    func keyPathSpending() throws {
        ...
        let hasher = SignatureHash(transaction: tx, input: 0, prevouts: utxosSpent, sighashType: SighashType?.none)
