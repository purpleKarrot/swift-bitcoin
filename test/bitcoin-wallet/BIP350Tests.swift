...
struct BIP350Tests {
    ...
    func ecToAddressCommand() throws {
        ...
        let pubkey = try #require(PubKey(compressed: [0x02, 0xd6, 0x88, 0x9c, 0xb0, 0x81, 0x03, 0x6e, 0x0f, 0xae, 0xfa, 0x3a, 0x35, 0x15, 0x7a, 0xd7, 0x10, 0x86, 0xb1, 0x23, 0xb2, 0xb1, 0x44, 0xb6, 0x49, 0x79, 0x8b, 0x49, 0x4c, 0x30, 0x0a, 0x96, 0x1d]))
        let address = TaprootAddress(pubkey).description
    ...
    func scriptToAddressCommand() throws {
        // Adding 0x02 to the internal public key here to make it a standard public key.
        let pubkeyData = try #require(Data([0x02, 0xf9, 0xf4, 0x00, 0x80, 0x3e, 0x68, 0x37, 0x27, 0xb1, 0x4f, 0x46, 0x38, 0x36, 0xe1, 0xe7, 0x8e, 0x1c, 0x64, 0x41, 0x76, 0x38, 0xaa, 0x06, 0x69, 0x19, 0x29, 0x1a, 0x22, 0x5f, 0x0e, 0x8d, 0xd8]))
        let pubkey = try #require(PubKey(compressed: pubkeyData))
        ...
        let address = TaprootAddress(pubkey, scripts: [script1, script2]).description
